...
export const postUpdateSchema: Yup.ObjectSchema<BasicPostIF> = Yup.object({
  title: Yup.string()
    .required('Title is required!')
    .min(MIN_TITLE_LETTERS, `Title must be at least ${MIN_TITLE_LETTERS} letters`)
    .max(MAX_TITLE_LETTERS, `Title must not exceed ${MAX_TITLE_LETTERS} letters`),
  text: Yup.string()
